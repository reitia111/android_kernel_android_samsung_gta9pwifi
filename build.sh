...
ZIP_NAME="ReiTia111-AnyKernel3-gta9pwifi-${GIT_SHA}.zip"
...
export CC="$ROOT_DIR/toolchains/clang-r383902b1/bin/clang"
export REAL_CC="$CC"
export CROSS_COMPILE="$ROOT_DIR/toolchains/clang-r383902b1/bin"
export CLANG_TOOL_PATH="$ROOT_DIR/toolchains/clang-r383902b1/bin"
