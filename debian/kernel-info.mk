...
DEVICE_FULL_NAME = Samsung Galaxy A9+ Wifi
...
# Defconfig to use
KERNEL_DEFCONFIG = vendor/gta9pwifi_eur_open_defconfig
...
# will be made.
KERNEL_IMAGE_DTB = vendor/qcom/blair.dtb
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = samsung/gta9/gta9pwifi/blair-sec.gta9pwifi.overlay.00.dtbo
...
# is defined too.
KERNEL_IMAGE_DTB_OVERLAY_DTB_DIRECTORY = arch/arm64/boot/dts/samsung/gta9/gta9pwifi
...
KERNEL_BOOTIMAGE_PATCH_LEVEL = 2025-10
...
# recommended.
FLASH_INFO_CPU = Qualcomm Technologies, Inc SM6375
...
# Set clang version
CLANG_VERSION = 11.0.2-r383902b1
...
BUILD_PATH = /buildd/sources/toolchains/clang-r383902b1/bin:/buildd/sources/toolchains/gcc-aarch64-4.9/bin
...
KERNEL_BOOTIMAGE_GENERATE := 0
KERNEL_RECOVERY_BOOTIMAGE_GENERATE := 0
KERNEL_BUILD_BOOTIMG := 0
